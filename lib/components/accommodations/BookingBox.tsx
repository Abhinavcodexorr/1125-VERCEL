...
const BookingBox = forwardRef<BookingBoxHandle, BookingBoxProps>(function BookingBox(
    ...
    return (
        ...
        >
            ...
            {/* 3. Quantity Column (GUEST Jaisa Design) */}
            {showQuantity && (
                <div className="py-4 md:py-0 md:px-[20px] relative w-full flex flex-col justify-between border-b md:border-b-0 md:border-r border-[#D8D0C8]">
                    <p className="text-[10px] sm:text-[11px] lg:text-[12px] uppercase tracking-[2px] text-[#A69C94] mb-2 font-jako-regular">
                        Quantity
                    </p>
                    <button
                        ...
                        className="w-full flex items-center justify-between text-left font-jako-bold text-[14px] font-[400]"
                    >
                        <span className="text-[#BC2623] text-[13px] sm:text-[14px] uppercase whitespace-nowrap overflow-hidden text-ellipsis min-w-0">
            ...
            {/* 4. Guests Column */}
            <div className={`py-4 md:py-0 ${showQuantity ? "md:pl-[28px]" : "md:px-[20px]"} relative w-full flex flex-col justify-between border-b md:border-b-0 border-[#D8D0C8]`}>
                <p className="text-[10px] sm:text-[11px] lg:text-[12px] uppercase tracking-[2px] text-[#A69C94] mb-2 font-jako-regular">
                    Guests
                </p>
                <button
